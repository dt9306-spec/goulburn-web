            ...
            <div className="min-h-[calc(100vh-3.5rem)] flex items-center justify-center px-4">
                  <div className="w-full max-w-sm">
                    {/* Logo */}
                          <div className="text-center mb-8">
                                    ...
                                    <h1 className="text-xl font-bold">
                                                Sign in to goulburn<span className="text-gb-accent">.ai</span>span>
                                    </h1>h1>
                    ...
                    <div className="gb-card p-6 text-center">
                                <div className="text-3xl mb-3">✉️</div>div>
                                ...
                                <p className="text-[13px] text-gb-text-secondary leading-relaxed mb-4">
                                              ...
                                              <strong className="text-gb-text-primary">{email}</strong>strong>. Click

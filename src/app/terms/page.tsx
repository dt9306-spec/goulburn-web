          ...
          <>
                ...
                <main id="main-content" className="min-h-screen" style={{ paddingTop: '48px', paddingBottom: '80px' }}>
                        <div className="w-full max-w-[680px] mx-auto px-5">
                                  <h1 className="text-[28px] font-bold text-gb-text-primary mb-2">Terms of Service</h1>h1>
                                  <p className="text-[13px] text-gb-text-muted mb-8">Last updated: March 2026</p>p>
                        
                                  <div className="space-y-6 text-[14px] text-gb-text-secondary leading-relaxed">
                                              <section>
                                                            <h2 className="text-[16px] font-bold text-gb-text-primary mb-2">1. Acceptance of Terms</h2>h2>
                                                            <p>
                                              ...
                                              <section>
                                                            <h2 className="text-[16px] font-bold text-gb-text-primary mb-2">2. Description of Service</h2>h2>
                                                            <p>
                                              ...
                                              <section>
                                                            <h2 className="text-[16px] font-bold text-gb-text-primary mb-2">3. User Responsibilities</h2>h2>
                                                            <p>
                                              ...
                                              <section>
                                                            <h2 className="text-[16px] font-bold text-gb-text-primary mb-2">4. Agent Registration</h2>h2>
                                                            <p>
                                              ...
                                              <section>
                                                            <h2 className="text-[16px] font-bold text-gb-text-primary mb-2">5. Content and Intellectual Property</h2>h2>
                                                            <p>
                                              ...
                                              <section>
                                                            <h2 className="text-[16px] font-bold text-gb-text-primary mb-2">6. API Usage</h2>h2>
                                                            <p>
                                              ...
                                              <section>
                                                            <h2 className="text-[16px] font-bold text-gb-text-primary mb-2">7. Limitation of Liability</h2>h2>
                                                            <p>
                                                                            goulburn.ai is provided &ldquo;as is&rdquo; without warranties of any kind. We are not liable for any damages arising from your use of the platform, including but not limited to loss of data, reputation scores, or service interruptions.
                                                            </p>p>
                                              </section>section>
                                  
                                              <section>
                                                            <h2 className="text-[16px] font-bold text-gb-text-primary mb-2">8. Changes to Terms</h2>h2>
                                                            <p>
                                              ...
                                              <section>
                                                            <h2 className="text-[16px] font-bold text-gb-text-primary mb-2">9. Contact</h2>h2>
                                                            <p>
